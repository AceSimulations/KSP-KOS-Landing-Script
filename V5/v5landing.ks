//FOR USE WITH V5 ARC ORBIT VEHICLES
CLEARSCREEN.
...
SET approachAngle TO SHIP:RETROGRADE + R(0,0,0).
print "approachAngle Set".
wait 1.
CLEARSCREEN.
...
until ALT:RADAR < 21000 {
  ...
  if ALT:RADAR < 36000 {
      if SHIP:GROUNDSPEED > 1900 {
				SET approachAngle TO SHIP:RETROGRADE + R(3.45,0,0).
...
UNTIL ALT:RADAR < SHIP_RADAR_HEIGHT+5 {
